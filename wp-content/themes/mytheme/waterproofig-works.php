<?php
/* Template Name: Waterproofing Works Page */
get_header();
?>
                            ...
                            <div class="breadcrumb-menu-2 d-flex justify-content-center">
                                <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                                    <ul class="trail-items-2">
                                        ...
                                        <li class="trail-item-2 trail-center"><a href="<?php echo site_url('index.php/services-v2-page/'); ?>"><span>Services</span></a></li>
                ...
                <div class="row g-50 align-items-center">
                    <div class="col-lg-6 order-lg-0 order-1 p-relative">
                        <div class="df-service5__thumb">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/services/waterproofing.webp" alt="img not found">
                        </div>
                ...
                <div class="row gy-5 wow fadeInUp" data-wow-delay=".3s">
                    <div class="col-lg-5 col-md-6">
                        ...
                        <div class="df-requirement__button-wrapper">
                            <a href="contact.php" class="primary-btn">Contact Us
