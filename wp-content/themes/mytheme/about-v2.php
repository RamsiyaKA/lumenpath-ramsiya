                    ...
                    <div class="col-xl-12">
                        <div class="labels">
                            ...
                            <div class="col-lg-6 col-12 d-none d-md-block">
                                <figure>
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/blog/blog-22.webp" alt="">
                                </figure>
                            </div>
                            ...
                            <div class="df-system__content row d-flex">
                                ...
                                <p>To be recognized as a leading provider of innovative trading and service solutions, driven by integrity, excellence, and a commitment to customer satisfaction.</p>
                                    ...
                                    <div class="col-lg-6 col-12 d-none d-md-block">
                                        <figure>
                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/blog/blog-21.webp" alt="">
                                        </figure>
                                    </div>
                            ...
                            <div class="df-system__content row d-flex">
                                ...
                                <div class="col-lg-6 col-12 d-none d-md-block">
                                    <figure>
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/blog/blog-23.webp" alt="">
                                    </figure>
                                </div>
...
<div class="row">
    <div class="col-lg-4 colmd-6 col-12">
        <figure>
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/blog/ISO.webp" alt="">
        </figure>
    </div>
    <div class="col-lg-4 colmd-6 col-12">
        <figure>
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/blog/FITVALF-DISCTRIBUTION-CERTIFICATE.webp" alt="">
        </figure>
    </div>
</div>
</div>
                ...
                <div class="col-xxl-9">
                    <div class="page-title-wrapper-2 text-center">
                        ...
                        <div class="breadcrumb-menu-2 d-flex justify-content-center">
                            <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                                <ul class="trail-items-2">
                                    <li class="trail-item-2 trail-begin"><a href="<?php echo home_url(); ?>"><span>Home</span></a></li>
                                    <li class="trail-item-2 trail-end"><span>About Us</span></li>
                                </ul>
                            </nav>
                        </div>
    ...
    <section class="df-about2__area section-spacing">
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <div class="df-about2__thumb-wrapper p-relative">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/bg/company-image.png" alt="Company Image">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="df-about2__content">
                        <h2 class="section__title">Trusted Services Since 2000</h2>
                        <p>AL-NOOR AL-HUDA is one of the familiar names in the Building Material Trading field in Qatar for more than a decade.</p>
                    </div>
                </div>
            </div>
        </div>
